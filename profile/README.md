...
1. **Browse the repositories** and find an area that interests you.
...
5. **Join the discussion** — new ideas, questions, and feedback are always welcome.

No contribution is too small — documentation fixes, examples, and bug reports are just as valuable as code.

## Discussions

Have a question, idea, or proposal? Join us in [GitHub Discussions](https://github.com/orgs/astro-tools/discussions).
